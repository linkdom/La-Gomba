                ...
                <div class="container-paragraph contact-form">
                    ...
                    <form method="POST" action="/blog/contact">
                        ...
                        <div class="input-group mb-3 email">
                            ...
                            <input type="text" class="form-control" name="email" aria-label="Default" aria-describedby="inputGroup-sizing-default" required>
                        </div>
                        <br>
                        <div class="input-group mb-3 subject">
                            ...
                            <input type="text" class="form-control" name="subject" aria-label="Default" aria-describedby="inputGroup-sizing-default" required>
                        </div>
                        <br>
                        <div class="input-group">
                            ...
                            <textarea name="body" class="form-control" aria-label="With textarea" rows="10" required></textarea>
                        </div>

                        <input style="width: 100%; margin-top: 20px;" class="btn btn-primary" type="submit" value="Submit">
